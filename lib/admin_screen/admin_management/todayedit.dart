...
class EditQuestionToday extends StatefulWidget {
  final String questionId;

  const EditQuestionToday({required this.questionId, super.key});

  @override
  State<EditQuestionToday> createState() => _EditQuestionTodayState();
}

class _EditQuestionTodayState extends State<EditQuestionToday> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Manage Question Today'),
        centerTitle: true,
