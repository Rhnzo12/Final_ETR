...
class EditPhilQuestion extends StatefulWidget {
  final String questionId;

  const EditPhilQuestion({required this.questionId, super.key});

  @override
  State<EditPhilQuestion> createState() => _EditPhilQuestionState();
}

class _EditPhilQuestionState extends State<EditPhilQuestion> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Manage Phil History Question'),
        centerTitle: true,
