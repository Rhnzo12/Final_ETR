...
class CurHistoryQuestionScreen extends StatefulWidget {
  const CurHistoryQuestionScreen({super.key});

  @override
  State<CurHistoryQuestionScreen> createState() =>
      _CurHistoryQuestionScreenState();
}

class _CurHistoryQuestionScreenState extends State<CurHistoryQuestionScreen> {
  ...
  void Answered() {
    ...
    FirebaseFirestore.instance.collection('users').doc(user!.uid).update({
      ...
      'curAnswered': DateTime.now().toString(),
    }).then((_) {
